...
// NLP search reducer
export const nlpSearchReducer = (state = { nlpResults: {} }, action) => {
  switch (action.type) {
    case NLP_SEARCH_REQUEST:
      return { loading: true };

    case NLP_SEARCH_SUCCESS:
      return {
        loading: false,
        success: true,
        nlpResults: action.payload,
      };

    case NLP_SEARCH_FAIL:
      return {
        loading: false,
        error: action.payload,
      };

    case NLP_SEARCH_RESET:
      return { nlpResults: {} };
