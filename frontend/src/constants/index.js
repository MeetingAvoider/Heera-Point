...
// NLP search with Gemini
export const NLP_SEARCH_REQUEST = "NLP_SEARCH_REQUEST";
export const NLP_SEARCH_SUCCESS = "NLP_SEARCH_SUCCESS";
export const NLP_SEARCH_FAIL = "NLP_SEARCH_FAIL";
export const NLP_SEARCH_RESET = "NLP_SEARCH_RESET";
