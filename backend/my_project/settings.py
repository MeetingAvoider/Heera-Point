...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'your-email@gmail.com'  # Replace with your sending email address
EMAIL_HOST_PASSWORD = 'your-app-password'  # Replace with your app password from Google

# Default email settings
DEFAULT_FROM_EMAIL = EMAIL_HOST_USER
EMAIL_SUBJECT_PREFIX = '[Shopkar] '
